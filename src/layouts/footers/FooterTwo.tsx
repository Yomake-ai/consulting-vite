            ...
            <div className="row">
              <div className="col-xxl-4 col-xl-12">
                <div className="luminix-footer-textarea pr-50">
                  <Link href="/">
                    <img width={139} height={60} src={logo_white1_img} alt="here is theme image" />
                  </Link>
                ...
                <div className="luminix-footer-menu2">
                  ...
                  <div className="luminix-instagram-wrap">
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_1_img} alt="here is theme image" /></Link>
                    </div>
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_4_img} alt="here is theme image" /></Link>
                    </div>
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_2_img} alt="here is theme image" /></Link>
                    </div>
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_5_img} alt="here is theme image" /></Link>
                    </div>
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_6_img} alt="here is theme image" /></Link>
                    </div>
                    <div className="luminix-instagram-thumb">
                      <Link href="/portfolio"><img width={95} height={94} src={footer_3_img} alt="here is theme image" /></Link>
                    </div>
                  </div>
                </div>
              </div>
