          ...
          <div className="row">
            <div className="col-lg-6 order-lg-2">
              <div className="luminix-about-thumb2" data-aos="fade-up" data-aos-duration="700">
                <img width={278} height={555} src={about1_img} alt="here is theme image" />
                <div className="luminix-about-thumb3" data-aos="fade-up" data-aos-duration="900">
                  <img width={278} height={440} src={about2_img} alt="here is theme image" />
                </div>
                <div className="luminix-about-card2">
                  <div className="luminix-about-card-icon">
                    <img width={62} height={62} src={icon3_img} alt="here is theme image" />
              ...
              <div className="luminix-about-thumb4">
                <img width={556} height={1110} src={about3_img} alt="here is theme image" />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="luminix-default-content">
                ...
                <div className="luminix-list-icon-content content2">
                  <ul>
                    <li>
                      <img width={23} height={23} src={icon2_img} alt="here is theme image" />
