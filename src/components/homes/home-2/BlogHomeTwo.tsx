        ...
        <div className="col-xl-6">
          <div className="luminix-blog-wrap2" data-aos="fade-up" data-aos-duration="700">
            <div className="luminix-blog-thumb2 thumb3">
              <img width={636} height={339} src={blog4_img} alt="here is theme image" />
            </div>
            <div className="luminix-blog-content2">
              <div className="luminix-blog-meta">
                <Link href="/blog"><img width={15} height={18} src={icon1_img} alt="here is theme image" />by admin</Link>
                <Link href="/blog"><img width={15} height={16} src={date_img} alt="here is theme image" />July 5, 2024</Link>
              </div>
        ...
        <div className="col-xl-6">
          <div className="luminix-blog-wrap3" data-aos="fade-up" data-aos-duration="900">
            <div className="luminix-blog-thumb3">
              <img width={306} height={283} src={blog5_img} alt="here is theme image" />
            </div>
            <div className="luminix-blog-content3">
              <div className="luminix-blog-meta">
                <Link href="/blog"><img width={15} height={18} src={icon1_img} alt="here is theme image" />by admin</Link>
                <Link href="/blog"><img width={15} height={16} src={date_img} alt="here is theme image" />July 3, 2024</Link>
              </div>
              <div className="title pt-0">
          ...
          <div className="luminix-blog-wrap3" data-aos="fade-up" data-aos-duration="1100">
            <div className="luminix-blog-thumb3">
              <img width={306} height={283} src={blog6_img} alt="here is theme image" />
            </div>
            <div className="luminix-blog-content3">
              <div className="luminix-blog-meta">
                <Link href="/blog"><img width={15} height={18} src={icon1_img} alt="here is theme image" />by admin</Link>
                <Link href="/blog"><img width={15} height={16} src={date_img} alt="here is theme image" />June 27, 2024</Link>
              </div>
              <div className="title pt-0">
