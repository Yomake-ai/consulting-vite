          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="luminix-p-wrap" data-aos="fade-up" data-aos-duration="700">
                <div className="luminix-p-thumb">
                  <img width={636} height={450} src={p1_img} alt="here is theme image" />
            ...
            <div className="col-lg-6">
              <div className="luminix-p-wrap" data-aos="fade-up" data-aos-duration="900">
                <div className="luminix-p-thumb">
                  <img width={636} height={450} src={p2_img} alt="here is theme image" />
                  <div className="luminix-p-content">
                    <h5>Company</h5>
                    <div className="luminix-p-btn">
                      <Link href="/single-portfolio">
          ...
          <div className="row">
            <div className="col-xl-4 col-lg-6">
              <div className="luminix-p-wrap" data-aos="fade-up" data-aos-duration="500">
                <div className="luminix-p-thumb">
                  <img width={416} height={450} src={p3_img} alt="here is theme image" />
                  <div className="luminix-p-content">
                    <h5>Area Analysis </h5>
                    <div className="luminix-p-btn">
                      <Link href="/single-portfolio">
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="luminix-p-wrap" data-aos="fade-up" data-aos-duration="700">
                <div className="luminix-p-thumb">
                  <img width={416} height={450} src={p4_img} alt="here is theme image" />
                  <div className="luminix-p-content">
                    <h5>Development</h5>
                    <div className="luminix-p-btn">
                      <Link href="/single-portfolio">
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="luminix-p-wrap" data-aos="fade-up" data-aos-duration="900">
                <div className="luminix-p-thumb">
                  <img width={416} height={450} src={p5_img} alt="here is theme image" />
                  <div className="luminix-p-content">
                    <h5>Support US</h5>
                    <div className="luminix-p-btn">
                      <Link href="/single-portfolio">
